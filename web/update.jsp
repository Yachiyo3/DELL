    ...
    <form action="update" method="post">
        ...
        <div class="form-group">
            ...
            <select name="birthplace" class="form-control">
                <option ${contact.birthplace=="广州"?"select":""}value="广州">广州</option>
				<option ${contact.birthplace=="广州"?"select":""}value="上海">上海</option>
                <option ${contact.birthplace=="广州"?"select":""}value="北京">北京</option>
                <option ${contact.birthplace=="大连"?"select":""}value="大连">大连</option>
